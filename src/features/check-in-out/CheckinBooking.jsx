  ...
  function handleCheckin() {
    ...
    if (addBreakfast) {
      checkin({
        ...
        breakfast: {
          hasBreakfast: true,
          extrasPrice: optionnalBreafastPrice,
          totalPrice: totalPrice + optionnalBreafastPrice,
        },
      });
    } else {
    ...
    <>
      ...
      {!hasBreakfast && (
        <Box>
          ...
          >
            Want to add breakfast for {optionnalBreafastPrice} ?
          </Checkbox>
        </Box>
      )}
      ...
      <Box>
        ...
        >
          ...
          {!addBreakfast
            ...
            : `${formatCurrency(totalPrice + optionnalBreafastPrice)} (${formatCurrency(
                totalPrice
              )} + ${formatCurrency(optionnalBreafastPrice)})`}
        </Checkbox>
      </Box>
